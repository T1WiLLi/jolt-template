package jolt.template.exception;
...
@Configuration(value = ConfigurationType.EXCEPTION_HANDLER)
        ...
        return switch (statusCode) {
            case 400 -> new ErrorInfo(
                    ...
                    new String[] { "Vérifiez que tous les champs requis sont remplis",
                            "Contrôlez le format des données", "Contactez le support si le problème persiste" },
                    true);
            case 401 -> new ErrorInfo(
                    "Authentification Requise",
                    "Vous devez vous connecter pour accéder à cette ressource.",
                    new String[] { "Connectez-vous avec vos identifiants", "Vérifiez si votre session a expiré",
            ...
            case 403 -> new ErrorInfo(
                    ...
                    new String[] { "Contactez l'administrateur pour obtenir l'accès",
                            "Vérifiez les permissions de votre compte", "Connectez-vous avec un autre compte" },
                    false);
            case 404 -> new ErrorInfo(
                    "Introuvable",
                    "La page ou la ressource que vous cherchez n'existe pas.",
                    new String[] { "Vérifiez l'URL pour les fautes de frappe", "Utilisez le menu de navigation",
                            "Recherchez ce dont vous avez besoin" },
                    false);
            case 408 -> new ErrorInfo(
                    "Délai Dépassé",
                    "La requête a pris trop de temps à traiter.",
                    new String[] { "Réessayez avec une requête plus simple", "Vérifiez votre connexion internet",
                            "Contactez le support si le problème persiste" },
                    true);
            case 429 -> new ErrorInfo(
                    "Limite de Débit",
                    "Trop de requêtes envoyées en peu de temps. Veuillez ralentir.",
                    new String[] { "Attendez quelques minutes avant de réessayer", "Réduisez la fréquence des requêtes",
            ...
            case 500 -> new ErrorInfo(
                    ...
                    new String[] { "Essayez de rafraîchir la page", "Attendez quelques minutes et réessayez",
                            "Contactez le support avec l'ID d'erreur" },
                    true);
            case 502 -> new ErrorInfo(
                    "Service Indisponible",
                    "Le service est temporairement indisponible.",
                    new String[] { "Réessayez dans quelques minutes", "Consultez la page de statut du service",
                            "Contactez le support si le problème persiste" },
                    true);
            case 503 -> new ErrorInfo(
                    ...
                    new String[] { "Attendez la fin de la maintenance",
                            "Consultez nos réseaux sociaux pour les mises à jour", "Réessayez plus tard" },
                    true);
